...
export default function Footer() {
    return (
        <footer className="relative z-10 py-20 border-t border-white/5 bg-[#010413]">
            <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
                        ...
                        <div className="flex gap-4">
                            {[
                                ...
                                <Link 
                                    key={i} 
                                    href={href} 
                                    className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-slate-400 hover:text-white hover:bg-primary transition-all border border-white/5"
                                >
                                    <Icon size={18} />
                                </Link>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            {["Web Design", "Development", "Mobile Apps", "Cloud Setup"].map(link => (
                                <li key={link}>
                                    <Link href="/services" className="text-slate-400 hover:text-primary transition-colors text-sm">
                                        {link}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            {["About", "Work", "Tech", "Contact"].map(link => (
                                <li key={link}>
                                    <Link href={`/${link.toLowerCase()}`} className="text-slate-400 hover:text-primary transition-colors text-sm">
                                        {link}
                                    </Link>
                                </li>
                            ))}
                ...
                <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/5 gap-4 text-xs font-medium text-slate-500">
