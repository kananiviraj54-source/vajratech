    ...
    return (
        <div className="min-h-screen pt-32 pb-24">
            ...
            <div className="px-6 mb-12 sticky top-24 z-30">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-6 items-center bg-white/80 backdrop-blur-xl p-4 rounded-3xl border border-slate-200">
                    ...
                    <div className="relative w-full md:w-80">
                        ...
                        <input 
                            ...
                            className="w-full pl-12 pr-6 py-3 rounded-2xl bg-slate-50 border border-slate-200 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-primary/50 transition-all focus:bg-white"
                        />
                    </div>
                </div>
            </div>
                        ...
                        <AnimatePresence mode="popLayout">
                            {filteredTechs.map((tech, i) => (
                                <motion.div
                                    ...
                                    className="glass-card rounded-3xl p-8 border-slate-200 hover:border-primary/30 group"
                                >
                                    <div className="flex justify-between items-start mb-6">
                                        ...
                                        <span className={`px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider ${
                                            tech.level === "Expert" ? "bg-green-500/10 text-green-600" : "bg-blue-500/10 text-blue-600"
                                        }`}>
                                            {tech.level}
                                        </span>
                                    </div>
                                    <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-primary transition-colors">{tech.name}</h3>
