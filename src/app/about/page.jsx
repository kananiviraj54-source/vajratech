...
export default function About() {
    return (
        <div className="min-h-screen pt-32 pb-24">
            ...
            {/* Content Section */}
            <section className="px-6 py-24 bg-[#010413] border-y border-white/5">
                    ...
                    <div className="lg:w-1/2 grid grid-cols-2 gap-4 w-full">
                        <div className="space-y-4">
                            <div className="glass-card rounded-3xl p-8 text-center aspect-square flex flex-col justify-center">
                                <div className="text-4xl font-black text-white mb-2 font-display">50+</div>
                                <div className="text-xs text-slate-500 font-bold uppercase tracking-wider">Ships</div>
                            </div>
                            <div className="glass-card rounded-3xl p-8 text-center bg-primary/10 border-primary/20 aspect-video flex flex-col justify-center">
                                <div className="text-2xl font-black text-white mb-2 font-display">2022</div>
                        ...
                        <div className="space-y-4 pt-8">
                            <div className="glass-card rounded-3xl p-8 text-center aspect-video flex flex-col justify-center">
                                <div className="text-2xl font-black text-white mb-2 font-display">12</div>
            ...
            <section className="px-6 py-32">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <Link 
                        href="/contact"
                        className="inline-flex items-center gap-2 px-10 py-4 rounded-2xl bg-white text-dark font-black hover:bg-slate-200 transition-colors"
                    >
